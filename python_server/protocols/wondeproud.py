"""WondeProud GPS protocol implementation."""
...
class WondeProudProtocol(BaseProtocol):
...
class WondeProudMessageHandler(BaseMessageHandler):
    """Message handler for WondeProud protocol."""
