"""Arusnavi GPS protocol implementation."""
...
class ArusnaviProtocol(BaseProtocol):
...
class ArusnaviMessageHandler(BaseMessageHandler):
    """Message handler for Arusnavi protocol."""
