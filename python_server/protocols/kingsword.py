"""KingSword GPS protocol implementation."""
...
class KingSwordProtocol(BaseProtocol):
...
class KingSwordMessageHandler(BaseMessageHandler):
    """Message handler for KingSword protocol."""
