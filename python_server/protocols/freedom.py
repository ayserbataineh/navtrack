"""Freedom GPS protocol implementation."""
...
class FreedomProtocol(BaseProtocol):
...
class FreedomMessageHandler(BaseMessageHandler):
    """Message handler for Freedom protocol."""
