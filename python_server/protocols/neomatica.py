"""Neomatica GPS protocol implementation."""
...
class NeomaticaProtocol(BaseProtocol):
...
class NeomaticaMessageHandler(BaseMessageHandler):
    """Message handler for Neomatica protocol."""
