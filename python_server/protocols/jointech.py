"""Jointech GPS protocol implementation."""
...
class JointechProtocol(BaseProtocol):
...
class JointechMessageHandler(BaseMessageHandler):
    """Message handler for Jointech protocol."""
