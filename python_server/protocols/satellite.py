"""Satellite GPS protocol implementation."""
...
class SatelliteProtocol(BaseProtocol):
...
class SatelliteMessageHandler(BaseMessageHandler):
    """Message handler for Satellite protocol."""
