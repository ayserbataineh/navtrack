"""Pretrace GPS protocol implementation."""
...
class PretraceProtocol(BaseProtocol):
...
class PretraceMessageHandler(BaseMessageHandler):
    """Message handler for Pretrace protocol."""
